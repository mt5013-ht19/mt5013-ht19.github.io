...
Read [R4DS](http://r4ds.had.co.nz/) chapter 7 about exploratory data analysis.

Solve *Exploring Categorical Data* and *Exploring Numerical Data* of the *Exploratory Data Analysis* course at [DataCamp](https://www.datacamp.com/enterprise/mt5013-ht19/assignments).
...
read_csv("../../Class_files/systembolaget2019-10-30.csv") %>%
...
The file [`Class_files/MM2001_results.csv`](https://github.com/MT5013-HT19/Class_files/blob/master/MM2001_results.csv) contains the age, sex, and grade on course Matematik I (MM2001) of 3201 students aged 18-40 years. An `NA` in the grade column means that the student has been registered but not yet completed the course.
