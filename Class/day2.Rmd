...
Complete assignments *Data wrangling* and *Data visualization* (first two chapters of [Introduction to the Tidyverse](https://www.datacamp.com/courses/introduction-to-the-tidyverse)) at [DataCamp](https://www.datacamp.com/enterprise/mt5013-ht18/assignments).
